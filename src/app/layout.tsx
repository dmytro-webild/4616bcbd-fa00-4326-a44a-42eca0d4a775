...
export const metadata: Metadata = {
  title: "LUXE - Exclusive Fashion Collections",  description: "Discover curated luxury fashion collections that celebrate timeless elegance and exceptional craftsmanship. Shop exclusive designs for the discerning customer.",  keywords: "luxury fashion, exclusive clothing, designer wear, aesthetic fashion, premium apparel",  metadataBase: new URL("https://yourdomain.com"),
  alternates: {
    canonical: "https://yourdomain.com"},
  openGraph: {
    title: "LUXE - Exclusive Fashion Collections",    description: "Discover curated luxury fashion collections that celebrate timeless elegance and exceptional craftsmanship.",    url: "https://yourdomain.com",    siteName: "LUXE",    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "LUXE - Exclusive Fashion Collections",    description: "Discover curated luxury fashion collections that celebrate timeless elegance and exceptional craftsmanship."},
};
